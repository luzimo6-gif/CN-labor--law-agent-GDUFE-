...
pip install streamlit langchain langgraph langchain-chroma langchain-openai langchain-community langchain-text-splitters pypdf python-dotenv requests fpdf2 -q
...
echo    2. 普法模式：直接回答法律疑问，不收集卷宗
echo    3. 案件模式：AI 自动提取案件信息到右侧表单
echo    4. 点击「📎附件」按钮可上传合同、截图等文件
echo    5. 当 AI 判断信息充足时，右侧面板会高亮提示
echo    6. 核对右侧卷宗信息，点击"生成法律分析报告"
echo    7. 右侧沉浸式 A4 纸预览报告，确认后下载 PDF
echo    8. 如需新案件，点击左侧边栏"彻底重置并开启新案"
echo.
